/**
 * Integration tests (CRUD + 2 question endpoints) using in-memory MongoDB
 */
...
describe('Questions', () => {
  ...
  test('GET /api/questions/average-weight returns numeric kg/lb', async () => {
    ...
    expect(res.body.countBreedsUsed).toBeGreaterThan(0);
  });
});
